...
import { PasswordsCommandableGrpcServiceV1 } from 'pip-services-passwords-node';
import { IPasswordsClientV1 } from '../../src/version1/IPasswordsClientV1';
import { PasswordsCommandableGrpcClientV1 } from '../../src/version1/PasswordsCommandableGrpcClientV1';
...
suite('PasswordsCommandableGrpcClientV1', ()=> {
    let service: PasswordsCommandableGrpcServiceV1;
    let client: PasswordsCommandableGrpcClientV1;
    ...
    suiteSetup((done) => {
        ...
        let references: References = References.fromTuples(
            ...
            new Descriptor('pip-services-passwords', 'service', 'commandable-grpc', 'default', '1.0'), service
        );
        controller.setReferences(references);
        service.setReferences(references);

        client = new PasswordsCommandableGrpcClientV1();
